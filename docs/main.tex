...
\end{center} \par
  ...
  \begin{center}
  \captionof{table}{Tabla 2. Arquitecturas resultantes del entrenamiento parcial en Iris y sus métricas} \label{table}
  \begin{tabular}{l c c c r}
    \hline \\ [-2ex]
...
\begin{center}
  \captionof{table}{Tabla 4. Arquitecturas resultantes del entrenamiento total en Car evaluation y sus métricas} \label{table}
  \begin{tabular}{l c c c r}
    \hline \\ [-2ex]
    & Entrenamiento & Validación & Pruebas & Proporción \\ [0.5ex]
    \hline \\ [-1ex]
...
\begin{center}
  \captionof{table}{Tabla 5. Arquitecturas resultantes del entrenamiento parcial en Car evaluation y sus métricas} \label{table}
  \begin{tabular}{l c c c r}
    \hline \\ [-2ex]
    & Entrenamiento & Validación & Pruebas & Proporción \\ [0.5ex]
    \hline \\ [-1ex]
...
\begin{center}
  \captionof{table}{Tabla 6. Métricas de las arquitecturas de la Tabla 5 entrenadas hasta el final} \label{table}
  \begin{tabular}{l c c c r}
    \hline \\ [-2ex]
    & Entrenamiento & Validación & Pruebas & Proporción \\ [0.5ex]
    \hline \\ [-1ex]
...
\begin{center}
  \captionof{table}{Tabla 7. Arquitecturas resultantes del entrenamiento parcial en California housing y sus métricas} \label{table}
  \begin{tabular}{l c c c r}
    \hline \\ [-2ex]
    & Entrenamiento & Validación & Pruebas & Proporción \\ [0.5ex]
    \hline \\ [-1ex]
...
\end{center} \par
\begin{center}
  \captionof{table}{Tabla 8. Métricas de las arquitecturas de la Tabla 7 entrenadas hasta el final} \label{table}
  \begin{tabular}{l c c c r}
    \hline \\ [-2ex]
    & Entrenamiento & Validación & Pruebas & Proporción \\ [0.5ex]
    \hline \\ [-1ex]
...
\end{center} \par
  ...
  En la Fig. \ref{fig:22} se muestra la evolución de las poblaciones a lo largo de las 80 generaciones. \par
  \begin{figure}[H]
    \centering
    ...
    \label{fig:22}
  \end{figure} \par
  El número de épocas seleccionado hacen que los individuos sobrepasen el 80\% de precisión. Como consecuencia, se logra una notable reducción en el \emph{categorical cross-entropy} a lo largo de las generaciones.\par
  Por tanto, el número estimado de épocas mostrado en la Eq. \ref{eq:6} para conjuntos de datos de más de 3500 instancias es mayor de lo estrictamente necesario, ya que bastaría con que los individuos llegasen al 60-70\% de precisión. Si tal fuera el caso, se podría determinar con más precisión si en este problema realmente no son útiles las arquitecturas con varias capas ocultas  y se reduciría el tiempo de ejecución. \par
  Para un entrenamiento parcial, el entrenamiento por individuo oscila entre los 9 y 14 minutos, llegando a un tiempo medio de ejecución de 5 horas y media. Reduciendo el número de épocas un 25\%, se reduce el tiempo medio a 4 horas. \par
  ...
  Se ha demostrado que, efectivamente, las soluciones obtenidas en el entrenamiento parcial, se corresponden en gran medida con las obtenidas en el entrenamiento total. \par
