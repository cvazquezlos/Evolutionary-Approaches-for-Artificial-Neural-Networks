...
\begin{document}
  ...
  \addtocontents{lof}{\vskip -1cm}
  \addtocontents{lot}{\vskip -1cm}
 ...
 \section*{\Large 5.2. Entrenamiento de individuos}
  ...
  \begin{center}
    \captionof{table}{Tabla 1. Arquitecturas resultantes del entrenamiento total en Iris y sus precisiones tras 80 ejecuciones} \label{table}
  ...
  \begin{center}
    \captionof{table}{Tabla 2. Arquitecturas resultantes del entrenamiento parcial en Iris y sus precisiones tras 13 épocas y 80 ejecuciones} \label{table}
    \begin{tabular}{l c c c r}
      \hline \\ [-2ex]
      \multirow{2}*{Arquitectura} & \multicolumn{3}{c}{Precisión} & \multirow{2}*{Proporción} \\
      & Entrenamiento & Validación & Pruebas & \\ [0.5ex]
  ...
  \begin{center}
    ...
    \begin{tabular}{l c c c}
      \hline \\ [-2ex]
      \multirow{2}*{Arquitectura} & \multicolumn{3}{c}{Precisión} \\
      & Entrenamiento & Validación & Pruebas \\ [0.5ex]
      \hline \\ [-1ex]
...
\end{center} \par
  ...
  \bibitem{Bohanec1988} Bohanec, M. and Rajkovic, V. (1990). DEX: An Expert System Shell for Decision Support. \emph{Sistemica}. 145-157.
