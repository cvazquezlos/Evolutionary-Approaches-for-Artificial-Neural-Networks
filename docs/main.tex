...
\begin{document}
  ...
  \begin{align*}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width = 0.55\textwidth]{resources/Fig16.pdf}
  ...
  En el proceso evolutivo, cada individuo tiene que ser entrenado para la obtención de su fitness. Como cada individuo codifica una arquitectura de red, cada individuo se transforma en una Red de Neuronas Artificial, el cual se entrena y se obtiene su accuracy.
