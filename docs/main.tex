...
% DEEP LEARNING
    ...
    \end{align*} \par
      ...
      Esta gramática permite, por tanto, la construcción de arquitecturas de redes neuronales con varias capas ocultas. Como estas redes están totalmente conectadas, crea palabras fáciles de interpretar y de decodificar, sin preocuparse sobre las conexiones entre las capas y entre las neuronas. \par
      La gramática no permite la creación de estructuras neuronales parcialmente conectadas. Puede ser fácilmente modificable para incluir la codificación de las funciones de activación de cada capa en la red. Esta modificación se puede ver en la gramática de la Eq. \ref{eq:4}.\par
  \begin{align*}
    ...
    \}
    \end{align*} \par
    La gramática anterior tiene las mismas ventajas que la mostrada en Eq. \ref{eq:3} pero sustituye el separador de capa por una función de activación. En este trabajo no se ha utilizado esta gramática actualizada, ya que sólo se ha enfocado el problema en problemas de clasficiación.
