...
\begin{document}
  ...
  \chapter{\vspace{-3cm}Agradecimientos}
  \vspace{-1cm}
  ...
  \chapter{\vspace{-3cm}Summary}
  \vspace{-1cm}
  This Master Thesis Dissertation consists in a research about Grammar-Guided Genetic Programming and its 
  \vfill
\end{document}
