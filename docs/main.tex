...
% DEEP LEARNING
 ...
 \section*{\Large 6.2. Entrenamiento de individuos}
  ...
  Este proceso puede verse en el diagrama de la Fig. \ref{fig:16}. Todo comienza con la creación del individuo, generado con el uso de reglas de producción elegidas al azar de la gramática. A continuación, con la palabra que codifica el individuo (leyendo los símbolos terminales de izquierda a derecha), se decodifica en forma de arquitectura neuronal. Esta arquitectura es uno de los parámetros que entran al entrenamiento de \emph{Keras}, permitiendo utilizar el algoritmo de retropropagación del gradiente para su entrenamiento. \par
...
sin una potencia de cómputo adecuada, habrá problemas que sean irresolubles, al menos con el entrenamiento total. Con el entrenamiento parcial, al reducir el número de épocas de forma considerable, es posible llegar a realizar una ejecución completa.
