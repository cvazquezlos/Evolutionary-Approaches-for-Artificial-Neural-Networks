...
% DEEP LEARNING
  ...
  \begin{itemize}
    ...
    \item Épocas. El número de épocas es el único elemento que difiere según se trate de un entrenamiento parcial o total. Para los entrenamientos totales, se utilizan 
    \item 
    \item División del conjunto de datos en entrenamiento, validación y test.
    \item 
  \end{itemize}
