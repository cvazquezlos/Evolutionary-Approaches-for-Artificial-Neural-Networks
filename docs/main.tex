...
\begin{center}
  \captionof{table}{Tabla 1. Arquitecturas resultantes del entrenamiento total en Iris} \label{table}
...
\end{center} \par
  ...
  \begin{center}
  \captionof{table}{Tabla 2. Arquitecturas de entrenamientos} \label{table}
  \begin{tabular}{l c c c r}
    \hline \\ [-2ex]
    & Entrenamiento & Validación & Pruebas & Proporción \\ [0.5ex]
    \hline \\ [-1ex]
...
\end{center} \par
  \begin{center}
  \captionof{table}{Tabla 3. Arquitecturas de entrenamientos} \label{table}
  \begin{tabular}{l c c c r}
    \hline \\ [-2ex]
    & Entrenamiento & Validación & Pruebas & Proporción \\ [0.5ex]
    \hline \\ [-1ex]
