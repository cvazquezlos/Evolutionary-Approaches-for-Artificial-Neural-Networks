...
\begin{document}
  ...
  \vspace{-1cm}
  La optimización matemática es la obtención de la mejor solución de un problema dado. Cada una de estas soluciones candidatas a ser la mejor es valorada según una función que medirá cuán buena es. 
