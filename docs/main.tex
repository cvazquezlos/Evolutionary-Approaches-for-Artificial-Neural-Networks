...
\begin{document}
  ...
  \addcontentsline{toc}{chapter}{\vspace{-3cm}{\LARGE 1. Introducción}}
  \vspace{-1cm}
  \begin{thebibliography}{00}
    \bibitem{Boyd2004} Boyd, S. and Vandenberghe, L. (2004). Convex Optimization. \emph{Cambridge University Press} (pp. 129).
  \end{thebibliography}
\end{document}
