...
% DEEP LEARNING
 ...
 \section*{\Large 6.2. Entrenamiento de individuos}
  ...
  Los resultados obtenidos tras 80 ejecuciones con el entrenamiento total de los individuos se muestra en la Tabla \ref{tab:1}.
\begin{center}
  \captionof{table}{Arquitecturas de entrenamientos} \label{tab:1}
