...
\begin{document}
  ...
  \begin{figure}[H]
    ...
    \label{fig:1}
  \end{figure}
  En Fig. \ref{fig:1} se puede apreciar este Ciclo Evolutivo. Todo comienza con una población inicial, que se corresponderá con un conjunto de individuos de tamaño que serán seleccionados 
