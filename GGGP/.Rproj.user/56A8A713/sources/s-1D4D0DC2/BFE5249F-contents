...
write.csv(analysis_results, file = "../results/classification/iris/executions_results_total.csv")
write.xlsx(analysis_results, file = "../results/classification/iris/executions_results_total.xlsx")
...
executions_plot <- ggplot(data = executions_plotting_data, aes(x = generation)) +
  ...
  ggtitle("Entrenamiento total de los individuos") + theme_classic() + theme(plot.title = element_text(hjust = 0.5))
